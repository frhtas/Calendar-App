...
// A fragment which we can add event with its name, from, to, description, location, reminders etc.
public class MeetingFragment extends Fragment {
    ...
    public MeetingFragment(Calendar selectedCalendarDay) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        editText_eventName.setHint(R.string.meeting);
        editText_eventName.requestFocus();
        editText_attendees = (EditText) view.findViewById(R.id.editText_attendees);
    ...
    public Calendar addNewMeeting() {
        String eventType = "meeting";
        String eventName = editText_eventName.getText().toString();
        String attendees =  editText_attendees.getText().toString();
        ...
        Event newMeetingEvent = new Event(eventType, dateFrom, dateTo, eventName, attendees, location, selectedRepeat, repeatCount, selectedReminders);

        CalendarHelper calendarHelper = new CalendarHelper(getContext());
        calendarHelper.addNewEvent(newMeetingEvent);
        return dateFrom;
    }
